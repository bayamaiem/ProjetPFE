...
@Component({
  selector: 'app-afficheliste-conteneur-recycleur-publier-dangereux',
  standalone: true,
  imports: [
    RowComponent,
    CommonModule,
  ...
  templateUrl: './afficheliste-conteneur-recycleur-publier-dangereux.html',
  styleUrl: './afficheliste-conteneur-recycleur-publier-dangereux.scss',
})
export class AffichelisteConteneurRecycleurPublierDangeruxComponent  {
