...
@Component({
  selector: 'app-afficheliste-conteneur-recycleur-publier-carton',
  standalone: true,
  imports: [
    RowComponent,
    CommonModule,
  ...
  templateUrl: './afficheliste-conteneur-recycleur-publier-carton.html',
  styleUrl: './afficheliste-conteneur-recycleur-publier-carton.scss',
})
export class AffichelisteConteneurRecycleurPublierCartonComponent {
