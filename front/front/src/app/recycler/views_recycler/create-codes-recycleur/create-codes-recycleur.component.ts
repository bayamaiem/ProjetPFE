...
@Component({
  selector: 'app-create-codes-recycleur',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './create-codes-recycleur.component.html',
  styleUrl: './create-codes-recycleur.component.scss'
})
export class CreateCodesRecycleurComponent implements OnInit {
  Codeform: FormGroup;
    ...
    if (this.Codeform.valid) {
      ...
      this.codeService.saveCode(formData).subscribe(
        (response: Code) => {
          ...
          this.Codeform.reset();
          this.router.navigate(['/recycleur/Gerer-codes']);
