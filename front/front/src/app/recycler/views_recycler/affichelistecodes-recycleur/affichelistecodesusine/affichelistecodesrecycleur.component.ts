...
@Component({
  selector: 'app-affichelistecodesrecycleur',
  standalone: true,
  ...
  templateUrl: './affichelistecodesrecycleur.component.html',
  styleUrl: './affichelistecodesrecycleur.component.scss'
})
export class AffichelistecodesrecycleurComponent {
