...
@Component({
  selector: 'app-afficheliste-conteneur-collecteur-publier-plastique',
  standalone: true,
  imports: [
    RowComponent,
    CommonModule,
  ...
  templateUrl: './afficheliste-conteneur-collecteur-publier-plastique.html',
  styleUrl: './afficheliste-conteneur-collecteur-publier-plastique.scss',
})
export class AffichelisteConteneurCollecteurPublierPlastiqueComponent implements OnInit {
