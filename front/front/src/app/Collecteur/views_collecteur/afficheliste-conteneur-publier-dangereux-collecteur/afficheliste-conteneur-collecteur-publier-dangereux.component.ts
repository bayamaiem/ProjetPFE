...
@Component({
  selector: 'app-afficheliste-conteneur-collecteur-publier-dangereux',
  standalone: true,
  imports: [
    RowComponent,
    CommonModule,
  ...
  templateUrl: './afficheliste-conteneur-collecteur-publier-dangereux.html',
  styleUrl: './afficheliste-conteneur-collecteur-publier-dangereux.scss',
})
export class AffichelisteConteneurCollecteurPublierDangeruxComponent  implements OnInit {
